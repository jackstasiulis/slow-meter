...
import ProfileCropFramingOverlay from './ProfileCropFramingOverlay';
...
/** Pan bounds inside viewport (UI worklet). */
...
export default function CoverCropModal({ visible, imageUri, onClose, onComplete }: Props) {
        ...
        <View style={styles.shell}>
          <GestureDetector gesture={composed}>
            <View style={styles.viewport} onLayout={onViewportLayout}>
              ...
              {ready && imageUri ? <ProfileCropFramingOverlay insets={insets} /> : null}
            </View>
          </GestureDetector>
          ...
          <View style={styles.chromeLayer} pointerEvents="box-none">
            ...
            <Text style={[styles.hint, { bottom: Math.max(insets.bottom, 12) + 72 }]} pointerEvents="none">
